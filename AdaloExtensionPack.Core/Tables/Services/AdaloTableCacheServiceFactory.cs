...
public class AdaloTableCacheServiceFactory(AdaloTableServiceFactory adaloTableServiceFactory,
...
{ 
    ...
    {
        return new AdaloTableCacheService<T>(memoryCache, adaloTableServiceFactory.Create<T>(options), options, serviceProvider);
    }

    public IAdaloTableCacheService<AdaloDynamicEntity> Create(AdaloTableOptions options)
    {
